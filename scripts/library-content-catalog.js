...
export const CATALOG = {
  ...
  statuses: {
    proposed: {
      ...
      gloss: { en: 'A conjecture we intend to test; no evidence yet.',                                        zh: '一个我们打算检验的猜想；尚无证据。' },
      color: '#a855f7',
    },
    supported: {
      label: { en: 'Supported',      zh: '支持' },
      gloss: { en: 'Evidence-backed but not formally proven.',                                                zh: '有证据支持但未经形式化证明。' },
      color: '#22c55e',
    },
    open: {
      label: { en: 'Open',           zh: '待定' },
      gloss: { en: 'Under active investigation; could go either way.',                                         zh: '正在积极调查中；结果可能向任一方向发展。' },
      color: '#3b82f6',
    },
    refuted: {
      label: { en: 'Refuted by us',  zh: '被我们否证' },
      gloss: { en: 'We tested it and falsified it ourselves.',                                                zh: '我们已亲自检验并否证了它。' },
      color: '#ef4444',
    },
    'self-corrected': {
      label: { en: 'Self-corrected', zh: '自我纠正' },
      gloss: { en: 'We published it, then found a confounder and retracted the strong form.',                  zh: '我们曾发表它，后发现混杂因素并撤回强论断。' },
      color: '#f59e0b',
    },
    proven: {
      label: { en: 'Proven (Lean)',  zh: '已证明' },
      gloss: { en: 'Backed by a machine-checked Lean proof.',                                                  zh: '由机器检验的 Lean 证明支撑。' },
      color: '#14b8a6',
    },
    live: {
      label: { en: 'Live evidence',  zh: 'Live evidence' },
      gloss: { en: 'Continuously refreshed evidence (live-lab canary).',                                       zh: '持续刷新的证据（实时实验室金丝雀）。' },
      color: '#06b6d4',
    },
  },

  // Reader journeys — curated paths for four personas surfaced on the home page
  journeys: [
    {
      id: 'new-here',
      label: { en: "I'm new here", zh: '初次访问' },
      description: { en: 'Understand what Lupine is, what it claims, and why it matters — without drowning in methods.', zh: '了解 Lupine 是什么、主张什么、为何重要 — 无需深入方法细节。' },
      path: ['readme', 'glossary', 'error-geometry-objects', 'conjecture-ledger', 'hyp-hyper-ribbon-universality', 'mlip-cloud-baseline-distill', 'research-evolution'],
    },
    {
      id: 'physicist',
      label: { en: 'Show me the physics', zh: '给我看物理' },
      description: { en: 'Evaluate the scientific claims against the evidence, from Fisher information to the 16-element benchmark.', zh: '从 Fisher 信息到 16 元素基准，用证据评估科学主张。' },
    ...
    },
    {
      ...
      description: { en: 'Understand the flywheel, the correction operator, and how to use the validation infrastructure.', zh: '了解飞轮、修正算子，以及如何使用验证基础设施。' },
    ...
    },
    {
      ...
      description: { en: 'Assess epistemic discipline, self-correction culture, and formal backing.', zh: '评估认识论纪律、自我纠正文化和形式化支持。' },
  ...
  categories: [
    {
      ...
      blurb: { en: 'Orientation, shared vocabulary, data provenance, and the research agenda. Start here if you are new.', zh: '方向、共享词汇、数据来源和研究议程。如果你是新来的，从这里开始。' },
    },
    {
      id: 'conjectures',
      label: { en: 'Conjectures & Proofs', zh: '猜想与证明' },
      blurb: { en: 'Every claim we have tested, its lifecycle status, and the evidence behind it. The hypothesis ledger.', zh: '我们检验过的每一个声明、其生命周期状态以及背后的证据。假设台账。' },
    },
    {
      id: 'methods',
    ...
    },
    {
      ...
      blurb: { en: 'Benchmarks, live-lab results, and the MLIP flywheel evidence chain.', zh: '基准测试、实时实验室结果和 MLIP 飞轮证据链。' },
    },
    {
      id: 'formalization',
      label: { en: 'Formalization', zh: '形式化' },
      blurb: { en: 'Lean-backed theorem proofs, build-locking contracts, and the formal proof ledger.', zh: 'Lean 支持的定理证明、构建锁定契约和形式化证明台账。' },
    },
    {
      id: 'changelog',
      label: { en: 'Progress Log', zh: '进展日志' },
      blurb: { en: 'What changed, why, and what is next. The narrative spine of the project.', zh: '改变了什么、为什么以及下一步。项目的叙事主线。' },
    },
    {
      id: 'references',
      label: { en: 'Reviews & References', zh: '评议与参考文献' },
      blurb: { en: 'The literature we build on, the funding context, and the adversarial reviews our claims passed before going public.', zh: '我们所依赖的文献、资金背景，以及我们的声明在公开发表前所通过的对抗性评议。' },
    },
    {
      id: 'operations',
      label: { en: 'Build & Operations', zh: '构建与运营' },
      blurb: { en: 'How this library was built, how to reproduce every claim, and the infrastructure behind it.', zh: '这个库是如何构建的、如何复现每一个声明，以及其背后的基础设施。' },
    },
  ],
  ...
  entries: [
    // ── Foundations & Vision ─────────────────────────────────────────────
    {
      ...
      tags: ['primer', 'onboarding', 'reference'],
    },
    {
      id: 'readme',
      source: 'README.md',
