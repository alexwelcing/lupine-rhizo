...
The remaining triggers were retained: pull-request jobs validate repository-owned evidence and code, main-branch push jobs are path-filtered, scheduled evidence work owns Rhizo data, and production mutations are manual or explicitly gated.
