...
- 2026-08-03: negative-results preprint source and 7-page PDF completed under `paper/negative-results-preprint/`; ten source digests and source-derived critical prose claims fail closed in the build. The paper reports Z1's 3.4–6.1× gate miss, Z3's 4/4 model-level correction degradation after 128/128 baseline cells completed, and the 14.55→63.40 GPa global-operator degradation. Reviewer-found gaps were closed by binding the raw 32×4 Z3 registry and global-operator lock directly, deriving claim tokens from their values, and synchronizing the public-library exports. Locked rows also corrected the stale “all 26 paths underpredicted” summary to 17/26 for MACE-MP small without changing the Z1 gate verdict.
