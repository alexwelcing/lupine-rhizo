...
**Certification boundary:** every corrected Cij MAE and every bulk/shear or other derived-modulus result in this diagnosis is an empirical benchmark result, **uncertified** as a correction license. Componentwise licenses certify an aggregate only when every included target component is independently licensed; derived maps require a separate vector-valued license.
