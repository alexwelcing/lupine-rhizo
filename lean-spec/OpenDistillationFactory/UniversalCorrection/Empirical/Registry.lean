/- This file is generated by tools/generate_lean_empirical_registry.py.
Do not edit it by hand.  Regenerate it after theorem or contract changes. -/
...
def claimContracts : List ClaimContractEntry := [
  ...
  { contractId := "correction.b0.v1", status := .withdrawn, epistemicGrade := .unsupportedOverScoped, scope := { structures := ["rocksalt", "perovskite"], properties := ["B0"], conditions := ["Round-3 negative same-class evidence"] }, leanBindingSupported := false },
