...
set -u
MODEL=chgnet
# Remaining chgnet paths EXCLUDING the six >=159-atom cells (indices 2, 8, 10,
# 18, 20, 23, 28), all marked waiting/deferred per owner decision 2026-07-20.
REMAINING="0,1,3,5,6,9,11,15,17,19,24,25"
